...
static int launchctl_update_schedule(int run_maintenance, int UNUSED(fd))
{
	if (run_maintenance)
...
static int schtasks_update_schedule(int run_maintenance, int UNUSED(fd))
{
	if (run_maintenance)
...
static int systemd_timer_update_schedule(int run_maintenance, int UNUSED(fd))
{
	if (run_maintenance)
